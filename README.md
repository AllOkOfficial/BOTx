...
𝘽𝙀𝙁𝙊𝙍𝙀 𝘿𝙀𝙋𝙇𝙊𝙔 𝙔𝙊𝙐 𝙈𝙐𝙎𝙏 𝙀𝘿𝙄𝙏 𝙇𝙄𝙉𝙆 𝙄𝙉 [𝙏𝙃𝙄𝙎 𝙇𝙄𝙉𝙀](https://github.com/AllOkOfficial/BOTx/blob/8a258fb9e2c92fdb8e78b465642e18f9f47b6dce/plugins/pm_filter.py#L444) 𝙏𝙊 𝙔𝙊𝙐𝙍 𝙍𝙀𝘿𝙄𝙍𝙀𝘾𝙏 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙇𝙄𝙉𝙆 . 𝙊𝙏𝙃𝙀𝙍𝙒𝙄𝙎𝙀 𝙔𝙊𝙐 𝘾𝘼𝙉𝙏 𝙏𝘼𝙆𝙀 𝙁𝙄𝙇𝙀𝙎 𝙁𝙍𝙊𝙈 𝘾𝙃𝘼𝙉𝙉𝙀𝙇
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/AllOkOfficial/BOTx)</br>

<details><summary>Deploy To VPS</summary>
<p>
<pre>
git clone https://github.com/AllOkOfficial/BOTx
# Install Packages
...
```
## Support
[Hᴏᴍʙᴀʟᴇ Cɪɴᴇᴍᴀs](https://telegram.dog/HombaleCinemasChat)

## Bot

[TᴇʟᴇMᴏᴠɪᴇsRᴏʙᴏᴛ](https://telegram.dog/TeleMoviesRobot)
...
[𝘊𝘳𝘦𝘢𝘵𝘰𝘳](https://telegram.dog/r2spr)
