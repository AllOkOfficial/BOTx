...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("Pʟᴇᴀsᴇ ʀᴇᴏ̨ᴜᴇsᴛ Aɢᴀɪɴ, Fɪʟᴇ Lɪɴᴋ ᴇxᴘɪʀᴇᴅ.", show_alert=True)
    movie = movies[(int(movie_))]
    await query.answer('I ᴀᴍ sᴇᴀʀᴄʜɪɴɢ ᴍᴏᴠɪᴇ👀')
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == "private":
            ...
            return await query.answer('Are You Happy 👀')
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('I ʜᴀᴠᴇ sᴇɴᴅ ʏᴏᴜ ғɪʟᴇs ᴘᴇʀsᴏɴᴀʟʏ , Cʜᴇᴄᴋ ᴍʏ ᴘᴍ', show_alert=True)
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/+GkhrGbctAh5hNTU1')
                        ]
                    ]
                )
            )
     ...
     [
        ...
        buttons = [[
        InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/HombaleCinemas'),
        InlineKeyboardButton('ᴍᴏᴠɪᴇ', url='https://t.me/HombaleCinemasChat'),
        InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.delete()
        ...
        await query.answer("sᴇɴᴅ ᴄᴏʀʀᴇᴄᴛ ᴍᴏᴠɪᴇ/sᴇʀɪᴇs ɴᴀᴍᴇ ғᴏʀ ʙᴇᴛᴛᴇʀ ʀᴇsᴜʟᴛs .\nᴛᴏ ɢᴇᴛ ʙᴇᴛᴛᴇʀ ʀᴇsᴜʟᴛ ғᴏʀ sᴇʀɪᴇs sᴇᴀʀᴄʜ ʟɪᴋᴇ ᴇxᴀᴍᴘʟᴇ ɢɪᴠᴇɴ, Eg - Stranger Things S01E01\n\n @ HᴏᴍʙᴀʟᴇCɪɴᴇᴍᴀs", True)
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("𝖢𝗁𝖾𝖼𝗄 𝗍𝗁𝖾 𝗌𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝗌𝖾𝗇𝖽 𝗂𝗇 𝗀𝗈𝗈𝗀𝗅𝖾. 𝖨𝖿 𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝗋𝖾𝗊𝗎𝖾𝗌𝗍𝖾𝖽 𝖥𝗈𝗋 𝖢𝖺𝗆 𝗉𝗋𝗂𝗇𝗍 𝖸𝗈𝗎 𝗐𝗂𝗅𝗅 𝗇𝗈𝗍 𝖦𝖾𝗍 𝗂𝗍.")
        await asyncio.sleep(8)
        await k.delete()
        return
    SPELL_CHECK[msg.message_id] = movielist
    btn = [InlineKeyboardButton("🔍ɢᴏᴏɢʟᴇ🔎", url=f'https://google.com/search?q={query}')]
    await msg.reply("𝖢𝗁𝖾𝖼𝗄 𝗍𝗁𝖾 𝗌𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝗌𝖾𝗇𝖽 𝗂𝗇 𝗀𝗈𝗈𝗀𝗅𝖾. 𝖨𝖿 𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝗋𝖾𝗊𝗎𝖾𝗌𝗍𝖾𝖽 𝖥𝗈𝗋 𝖢𝖺𝗆 𝗉𝗋𝗂𝗇𝗍 𝖸𝗈𝗎 𝗐𝗂𝗅𝗅 𝗇𝗈𝗍 𝖦𝖾𝗍 𝗂𝗍.",
                    reply_markup=InlineKeyboardMarkup(btn))
