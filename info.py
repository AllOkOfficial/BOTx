...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📝 File Name : <code>[HombaleCinemas] {file_name}</code>\n🧲 File Size :<i>{file_size}</i>\n<b>Join [Here](https://t.me/HombaleCinemasChat)</b>reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('♨️ 𝖠𝖽𝖽 𝖡𝗈𝗍 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈𝗎𝗉 ♨️', url ="https://t.me/TeleMoviesRobot?startgroup=true")])")
