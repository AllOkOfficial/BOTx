...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📝 File Name : <code>[HombaleCinemas] {file_name}</code>\n🧲 File Size :<i>{file_size}</i> buttons = [[InlineKeyboardButton('Subscribe', url =f't.me/HombaleCinemas'),InlineKeyboardButton('Support Chat', url =f't.me/HombaleCinemasChat')]]")
